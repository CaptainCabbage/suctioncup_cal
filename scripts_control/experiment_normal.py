...
task_model = taskModel2('vc_calibration_Nmm.json','./task_files/task_normal.json')

# test error
#error = 2
#task_model.origin[2] = task_model.origin[2] + error
# higher object
#task_model.actual_start[2] = task_model.actual_start[2] + 84- 76.8

bagname = 'normal_' + str(int(time.time())) + '.bag'
...
task_model.actual_start[2] = task_model.actual_start[2]-1
...
for i in range(task_model.total_timestep-1):
    ...
    #if i % 5 == 0:
    #    raw_input('go measure the angle!')
